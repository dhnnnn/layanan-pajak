<x-layouts.field-officer title="Pencapaian Target" header="Pencapaian Target Wilayah Tugas">
    <x-slot:headerActions>
        <a href="{{ route('field-officer.monitoring.export-pdf', ['year' => $year]) }}"
        ...
        <a href="{{ route('field-officer.monitoring.export-excel', array_filter(['year' => $year, 'status_filter' => $statusFilter, 'tax_type_id' => $taxTypeId ?? '', 'district_id' => $districtId ?? '', 'search' => $search ?? ''])) }}"
