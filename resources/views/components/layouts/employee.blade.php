        ...
        <div class="lg:contents">
            ...
            <aside x-show="sidebarOpen || window.innerWidth >= 1024"
                ...
                <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto text-sm scrollbar-hide">
                    ...
                    <x-layouts.sidebar-item route="pegawai.realizations.index" :active="request()->routeIs('pegawai.realizations.*')" activeClass="bg-emerald-600 text-white">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <x-layouts.sidebar-item route="pegawai.import.index" :active="request()->routeIs('pegawai.import.*')" activeClass="bg-emerald-600 text-white">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
